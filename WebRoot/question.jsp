...
<html>
  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        <button class="layui-btn" id="addQuestion" ><i class="layui-icon"></i>添加</button>
...
/*工作类型-修改 */
	function updateMed(code){
		...
		var url = 'question-update.jsp?mId='+code;
	...
	$("#addQuestion").click(function(){
			 ...
			 var _tools = {
			  ...
			  window.tools = _tools;
			x_admin_show('添加工作类型','./question-add.jsp?mId='+departId+'&workcode='+postionCode,600,400);
	 ...
	 function reloadPage(){
			...
			if(departId!=""){
				$.ajax({
					url:"<%=basePath%>/checkWork/question/getquestion",
					data: {'deptId':departId,'postionCode':postionCode},
					dataType:"json",
					type:"post",
					success:function(result){
						if(result.success ==true){
							...
							for(var i=0;i<medicine.length;i++){
								...
								var question = medicine[i].question;
								var dataNum = 0;
								str += '  <tr>';
								str += ' 	<td>';
