...
public class JiPushUtil {
    ...
    private final static String appKey = "fd4f12712023c5ceefb3d556";
 
    private final static String masterSecret = "07298e0da45ee17f89895697";
   ...
   * @throws InterruptedException 
     */
    public static int sendToRegistrationId( String registrationId,String notification_title, String msg_title, String msg_content, String extrasparam) throws InterruptedException {
        int result = 0;
        try {
            PushPayload pushPayload= JiPushUtil.buildPushObject_all_registrationId_alertWithTitle(registrationId,notification_title,msg_title,msg_content,extrasparam);
    ...
    public static PushPayload buildPushObject_all_registrationId_alertWithTitle(String registrationId,String notification_title, String msg_title, String msg_content, String extrasparam) {
    ...
    public static void main(String[] args) {
    	...
    	aliasList.add("18363527384");
		int num=JiPushUtil.sendToAliasList(aliasList, "这是title", "这是msgtitle", "这是信息内容", "");
