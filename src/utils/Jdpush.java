...
public  class Jdpush {  
   ...
   public static final String TITLE = "这是测试";  
   public static final String ALERT = "祝大家新春快乐";  
   public static final String MSG_CONTENT = "祝新老客户新春快乐";  
   public static final String REGISTRATION_ID = "1a0018970aeaa2172ff";  
   ...
   public static void main(String[] args) {
	new Jdpush().testSendPush("fd4f12712023c5ceefb3d556", "07298e0da45ee17f89895697");
}
}